...
import 'package:cardgametest1/Authtentication/login.dart';
import 'package:cardgametest1/JsonModels/users.dart';
import 'package:cardgametest1/SQLite/sqlite.dart';
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        color: Color.fromARGB(255, 237, 159, 82).withOpacity(.2)),
                    child: TextFormField(
                      controller: username,
                      validator: (value) {
                        if (value!.isEmpty) {
